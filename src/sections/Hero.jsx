  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {statistics.map((singleStat) => (
            <div key={singleStat.label}>
              <p className='text-4xl font-palanquin font-bold'>{singleStat.value}</p>
              <p className='leading-7 font-montserrat text-slate-gray'>{singleStat.label}</p>
            </div>
          ))}
        </div>
      </section>
